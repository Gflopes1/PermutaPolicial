...
module.exports = {
  ...
  getResumoPublico: handle((req) =>
    editaisService.getResumoPublico(parseInt(req.params.id, 10))
  ),

  serveSharePage: editalShareController.serveSharePage,

  getConsultaPublica: handle((req) =>
    editaisService.getConsultaPublica(
      parseInt(req.params.id, 10),
      req.query.id_funcional
    )
  ),
