...
module.exports = {
  ...
  addPointPhotos: handleRequest(mapaTaticoService.addPointPhotos),
  deletePointPhoto: handleRequest(mapaTaticoService.deletePointPhoto),
  getOccurrenceLog: handleRequest(mapaTaticoService.getOccurrenceLog),
  createOccurrenceLogEntry: handleRequest(mapaTaticoService.createOccurrenceLogEntry, 201),
  getSuspectProfile: handleRequest(mapaTaticoService.getSuspectProfile),
  upsertSuspectProfile: handleRequest(mapaTaticoService.upsertSuspectProfile),
  archiveSuspectProfile: handleRequest(mapaTaticoService.archiveSuspectProfile),
  getSuspectDisclaimerStatus: handleRequest(mapaTaticoService.getSuspectDisclaimerStatus),
  acknowledgeSuspectDisclaimer: handleRequest(mapaTaticoService.acknowledgeSuspectDisclaimer),
};
