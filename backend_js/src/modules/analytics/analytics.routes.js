...
router.get(
  ...
  authMiddleware,
  adminMiddleware,
  analyticsController.getUsuariosPorEstado
);
...
router.get(
  ...
  authMiddleware,
  adminMiddleware,
  analyticsController.getUsuariosPorForcaDetalhado
);
...
router.get(
  ...
  authMiddleware,
  adminMiddleware,
  celebrate(analyticsValidation.getContasAtivas),
  analyticsController.getContasAtivas
);
...
router.get(
  ...
  authMiddleware,
  adminMiddleware,
  celebrate(analyticsValidation.getMediaKitExport),
  analyticsController.getMediaKitExport
);
...
router.get(
  ...
  authMiddleware,
  adminMiddleware,
  celebrate(analyticsValidation.getResumoAdmin),
  analyticsController.getResumoAdmin
);
