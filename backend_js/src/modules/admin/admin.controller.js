...
module.exports = {
  ...
  rebuildPermutasInteligentesGraph: handleRequest(
    () => adminService.rebuildPermutasInteligentesGraph(),
    200
  ),
  getActivityLogs: handleRequest(
    (req) => adminService.getActivityLogs({
