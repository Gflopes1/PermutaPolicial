-- ============================================
-- VERIFICA E CRIA TABELA daily_usage_limits
...
WHERE table_schema = DATABASE() 
  AND table_name = 'daily_usage_limits';

-- Cria a tabela se não existir
CREATE TABLE IF NOT EXISTS daily_usage_limits (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NOT NULL,
    feature VARCHAR(50) NOT NULL COMMENT 'Nome da feature: ai_consult, practice_questions',
...
SELECT 'Tabela daily_usage_limits criada/verificada com sucesso!' as status;
