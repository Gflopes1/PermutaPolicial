...
class IntencoesRepository {
  ...
  Future<Map<String, dynamic>> renewMyIntentions() async {
    final responseData = await _apiClient.post('/api/intencoes/me/renovar', {});
    return responseData;
  }

  Future<Map<String, dynamic>> markPermutaConcluida() async {
    final responseData = await _apiClient.post('/api/intencoes/me/consegui-permutar', {});
    return responseData;
  }
}
