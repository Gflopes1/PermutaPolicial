...
class MarketplaceProvider with ChangeNotifier {
  ...
  MarketplaceProvider(this._repository, this._analyticsService);
  ...
  Future<void> loadItens({
    ...
    try {
      ...
      if (e is ApiException && e.statusCode != 404) {
        ...
        await ErrorHandler.trackError(_analyticsService, e, endpoint: '/api/marketplace', method: 'GET');
      } else if (e is ApiException && e.statusCode == 404) {
        // 404 não é erro, apenas não há resultados
        _errorMessage = null;
      } else {
  ...
  Future<void> loadMeusItens(int policialId) async {
    ...
    try {
      ...
      if (e is ApiException && e.statusCode != 404) {
        _errorMessage = e.userMessage;
        await ErrorHandler.trackError(_analyticsService, e, endpoint: '/api/marketplace/meus-itens', method: 'GET');
      } else if (e is ApiException && e.statusCode == 404) {
        // 404 não é erro, apenas não há resultados
        _errorMessage = null;
      } else {
  ...
  Future<bool> createItem({
    ...
    try {
      ...
      _errorMessage = ErrorHandler.getErrorMessage(e);
      await ErrorHandler.trackError(_analyticsService, e, endpoint: '/api/marketplace', method: 'POST');
      return false;
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  Future<bool> updateItem({
    ...
    try {
      ...
      _errorMessage = ErrorHandler.getErrorMessage(e);
      await ErrorHandler.trackError(_analyticsService, e, endpoint: '/api/marketplace/$id', method: 'PUT');
      return false;
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  Future<bool> deleteItem(int id) async {
    ...
    try {
      ...
      _errorMessage = ErrorHandler.getErrorMessage(e);
      await ErrorHandler.trackError(_analyticsService, e, endpoint: '/api/marketplace/$id', method: 'DELETE');
      return false;
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  Future<void> loadItensAdmin({String? status}) async {
    ...
    try {
      ...
      _errorMessage = ErrorHandler.getErrorMessage(e);
      await ErrorHandler.trackError(_analyticsService, e, endpoint: '/api/marketplace/admin/todos', method: 'GET');
      _itensAdmin = [];
    } finally {
      _isLoading = false;
  ...
  Future<bool> aprovarItem(int id) async {
    ...
    try {
      ...
      await loadPendentesCount();
      return true;
    } catch (e) {
      debugPrint('aprovarItem: ERRO - $e');
      _errorMessage = ErrorHandler.getErrorMessage(e);
      await ErrorHandler.trackError(_analyticsService, e, endpoint: '/api/marketplace/admin/$id/aprovar', method: 'PUT');
      return false;
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  Future<bool> rejeitarItem(int id) async {
    ...
    try {
      ...
      _errorMessage = ErrorHandler.getErrorMessage(e);
      await ErrorHandler.trackError(_analyticsService, e, endpoint: '/api/marketplace/admin/$id/rejeitar', method: 'PUT');
      return false;
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  Future<bool> deleteItemAdmin(int id) async {
    ...
    try {
      ...
      _errorMessage = ErrorHandler.getErrorMessage(e);
      await ErrorHandler.trackError(_analyticsService, e, endpoint: '/api/marketplace/admin/$id', method: 'DELETE');
      return false;
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  // Carrega contagem de anúncios pendentes
  Future<void> loadPendentesCount() async {
    try {
      _pendentesCount = await _repository.countPendentes();
      notifyListeners();
    } catch (e) {
      debugPrint('Erro ao carregar contagem de pendentes: $e');
      _pendentesCount = 0;
      notifyListeners();
    }
  }
