                ...
                children: [
                  ...
                  CustomDropdownSearch<dynamic>(
                    ...
                    onChanged: (data) => setState(() {
                      _selectedEstadoId = getItemId(data);
                      _selectedMunicipioId = null;
                      _selectedUnidadeId = null;
                      _municipioKey.currentState?.clear();
                      _unidadeKey.currentState?.clear();
                  ...
                  CustomDropdownSearch<dynamic>(
                    ...
                    onChanged: (data) => setState(() {
                      _selectedMunicipioId = getItemId(data);
                      _selectedUnidadeId = null;
                      _unidadeKey.currentState?.clear();
                    }),
                  ),
                  ...
                  CustomDropdownSearch<dynamic>(
                    ...
                    onChanged: (data) => setState(() => _selectedUnidadeId = getItemId(data)),
                    onSuggestUnidade: _selectedMunicipioId != null
                        ? () {
                            showDialog(
                              context: context,
