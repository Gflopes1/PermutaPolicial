  ...
  Future<void> _criarTopico() async {
    ...
    if (_categoriaSelecionada == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        AppStyles.errorSnackBar('Selecione uma categoria'),
      );
      return;
    }
    ...
    if (success) {
      context.pop();
      ScaffoldMessenger.of(context).showSnackBar(
        AppStyles.successSnackBar('Tópico criado com sucesso!'),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        AppStyles.errorSnackBar(provider.errorMessage ?? 'Erro ao criar tópico'),
      );
    }
  }
