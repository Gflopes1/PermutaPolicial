...
class NotificacoesRepository {
  /** Notificações de contato — leve, para enriquecer matches de permuta */
  async findContactStatusByUsuario(usuarioId) {
    const query = `
      SELECT
        n.tipo,
        n.referencia_id,
        n.lida,
        p_aceitador.nome as aceitador_nome,
        p_aceitador.qso as aceitador_contato,
        f_aceitador.nome as aceitador_forca_nome,
        f_aceitador.sigla as aceitador_forca_sigla,
        es_aceitador.sigla as aceitador_estado_sigla,
        m_aceitador.nome as aceitador_cidade_nome,
        u_aceitador.nome as aceitador_unidade_nome,
        pg_aceitador.nome as aceitador_posto_nome
      FROM notificacoes n
      LEFT JOIN policiais p_aceitador
        ON n.referencia_id = p_aceitador.id AND n.tipo = 'SOLICITACAO_CONTATO_ACEITA'
      ...
      WHERE n.usuario_id = ?
        AND n.tipo IN ('SOLICITACAO_CONTATO', 'SOLICITACAO_CONTATO_ACEITA')
