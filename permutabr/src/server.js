...
const fcmV1 = require('./src/modules/push/fcm-v1.client');
        ...
        try {
            ...
            const server = app.listen(PORT, HOST, () => {
                ...
                if (process.env.ENABLE_MATCH_ALERTS_JOB !== 'false') {
                    const matchAlertsJob = require('./src/modules/match-alerts/match-alerts.job');
                    matchAlertsJob.startMatchAlertsJob();
                }

                if (process.env.ENABLE_PERMUTAS_INTELIGENTES_JOB !== 'false') {
                    const piJob = require('./src/modules/permutas-inteligentes/permutas-inteligentes.job');
